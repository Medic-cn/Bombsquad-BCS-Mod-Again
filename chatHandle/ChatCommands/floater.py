...
def assignFloInputs(clientID: int):
    with ba.Context(_ba.get_foreground_host_activity()):
        ...
        if floater.controlled:
            ba.screenmessage('有人正在控制无人机🪄wing...', color=(1, 0, 0), transient=True, clients=[clientID])
            return
        ba.screenmessage('你正在控制无人机🪄\n 按炸弹键投炸弹，拳击键离开无人机🫡', clients=[clientID], transient=True, color=(0, 1, 1))
