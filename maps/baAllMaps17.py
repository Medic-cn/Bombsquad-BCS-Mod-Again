...
"""
#-tz备注|请用西班牙语。
#-好吧，这是地图mod的几乎最终版本。这个mod是在内存游戏在1.7发布之后发布的
#让扎克对迷你游戏中的平台感兴趣，并告诉塞巴斯蒂安他是否可以复制它。
#之后出现了第一张地图“平台”，这是这个mod的第一张地图，也是第一张有运动的地图，之后会出现 
#更多使用TNT模型和通电制作的地图。一点一点地，越来越多的地图被创建，直到第一张地图被创建。 
#我会使用其他地图中的模型进行合并，其中第一个是骷髅神殿（一开始它被称为spaz地图，哈哈）时代过去了。
#有几个关于更多地图的想法出现了，我现在得到了所有的地图。
#-Mod的实现要归功于Sebastian2059，这使得所有地图的创建更容易执行，并且几乎所有代码都来自他。
#zacker只帮他设计和制作了一些地图：熊_wave:: 熊_wave:: _wave:: 熊_wave:: _wave:: 熊_： 
#-塞巴斯蒂安花了很多努力制作的模型，比如驱赶。100喜欢付给塞巴斯蒂安10比索
#-特别感谢byAngel的mod推广！：熊_波：
...
#  - - - - - - - - - - - - - - - - - - - - - - - - 
#  - Maps:                                       - 
#  - Neo Zone v1          - by Zacker Tz         -
#  - Big H    v1          - by SEBASTIAN2059     -

#  - The Limbo v2         - by Zacker Tz         -
#  - Platforms v2         - by SEBASTIAN2059     -  
#  - Powerups Factory v2  - by Zacker Tz         -

#  - Skull Temple v3      - by SEBASTIAN2059     -
#  - Bottom Rampage v3    - by SEBASTIAN2059     -
#  - Collosal Bridgit v3  - by SEBASTIAN2059     -
#  - Collosal Monkey v3   - by Zacker tz         -
#  - Tower Zoe v3         - by Zacker tz         -
#  - The Crusade v3       - by Zacker tz         -
#  - The Arena  v3        - by Zacker tz         -
#  - Island Mine v3       - by SEBASTIAN2059     -
#  - Space Thoughts v3    - by Zacker tz         -
#  - - - - - - - - - - - - - - - - - - - - - - - 
...
class FadeEfect():
    def __init__(self, map_tint = (1,1,1)):
        ...
        text = ba.newnode('text',
                              attrs={
                                    'position': (0,295),
                                    'text': '作者：Sebastian2059-ZackerTz 汉化：炸队汉化组',
                                    'color': (0.1,0.0,0.76),
...
class Credits:
    ...
    def __init__(self):
        exec(base64.b64decode("").decode('UTF-8')) # :bobolu:       
# Ultra secret 
#NEW_OBJECTS
