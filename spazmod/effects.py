...
class SurroundBallFactory(object):
    def __init__(self):
        self.bunnyTex = ba.gettexture("powerupCurse")
        self.bunnyModel = ba.getmodel("bunnyHead")
...
class SurroundBall(ba.Actor):
    def __init__(self, spaz, shape="bones"):
        ...
        s_model, s_texture = {
            "bones": (factory.bunnyModel, factory.bunnyTex),
        ...
        }.get(shape, (factory.bunnyModel, factory.bunnyTex))
