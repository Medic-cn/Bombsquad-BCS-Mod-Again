...
#	credits = 'Created by MattZ45986 on Github | Updated by byANG3L | Chinese＆Issue:edMedic'
#	you_were = 'You were'
#	cursed_text = 'CURSED'
#	run = 'RUN'
...
#else:
name = '运气旗'
description = '举起旗帜，猜猜会发生什么\n(ˉ▽ˉ；)......'
slow_motion_deaths = '慢动作死亡'
credits = '作者：MattZ45986 | 升级：byANG3L | 汉化/发行：药服技术社/炸队汉化组👻'
you_were = '你被'
cursed_text = '诅咒了👻！！'
run = '傻孩子快跑！！！'
climb_top = '爬到最上面去~'
