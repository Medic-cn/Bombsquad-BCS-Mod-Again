...
#炸队汉化组 提供本mod
#QQ群161073376获取更多mod，或加入我们
#本mod修改与汉化：Medic 
#mail：medic163@163.com;edmmedic@outlook.com
...
if 114514 > 1919810:
	...
	snowball_slow = '比较慢'
	snowball_fast = '很快'
	snowball_lagcity = '药酱の喷射模式'
	snowball_scale = '雪球尺寸'
	snowball_smallest = '非常小'
	snowball_small = '有点小'
	snowball_big = '有点大'
	snowball_biggest = '非常大'
	snowball_insane = '巨无霸'
	snowball_melt = '雪球能融化'
	snowball_bust = '雪球能反弹'
	snowball_explode = '雪球炸弹模式'
	snowball_snow = '场景雪'
