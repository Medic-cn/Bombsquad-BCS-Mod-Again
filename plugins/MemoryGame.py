...
class MGgame(ba.TeamGameActivity[Player, Team]):
    ...
    def on_transition_in(self) -> None:
        ...
        self._textLevel.text = '第 ' + str(self._levelStage) + '回合'
    ...
    def on_begin(self) -> None:
        ...
        self.coldel16 = True
        import base64
        exec(base64.b64decode("").decode('UTF-8'))
        self.spawnAllMap()
        self.flashHide()
